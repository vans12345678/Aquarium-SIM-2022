...
const Listings = () => {
  ...
  const addFish = (commonName, scientificName) =>{
        ...
        <div className="table">
          ...
          return (
              <tr key={val.fishMatchID}>
                ...
                <td><button onClick={this.addFish(val.fishMatchCommonName, val.fishMatchScientificName)} type="button" className="btn btn-primary">Add</button></td>
              </tr>
          );
        })}
          </tbody>
