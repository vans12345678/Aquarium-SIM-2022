...
const Aquarium = () => {
    ...
    if (testTankSize(inputLength, inputWidth, inputHeight) == true) {
      if (
        ...
        parseInt(inputHeight) != fishTank.height
            ...
            var tempLength = parseInt(inputLength);
            var tempWidth = parseInt(inputWidth);
            var tempHeight = parseInt(inputHeight);
            fishTank.size = Math.round(
              (tempLength *
              tempWidth *
                tempHeight) /
            ...
            if (updateTankCapacity(userList) == true)
            {
              fishTank.length = tempLength;
              fishTank.width = tempWidth;
              fishTank.height = tempHeight;
            }
            else{
              fishTank.size = Math.round(
                (fishTank.length *
  ...
  function updateTankCapacity(userList) {
    var tempCapacity = 0;
