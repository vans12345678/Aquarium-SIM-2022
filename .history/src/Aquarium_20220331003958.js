...
const Aquarium = () => {
  ...
  const addFish = (value) => {
    ...
    let arrFish = [value.fishID, value.fishCommonName, value.fishScientificName, value.fishAverageSize, value.fishLowerPH, value.fishUpperPH, value.fishLowerTemp, 
      value.fishUpperTemp, value.fishAggrSameSpecies, value.fishAggrOtherSpecies, value.fishLocationTank, value.fishImage];
    userList.push(arrFish);
    ...
    <div>
      <section className="home">
        ...
        <p className="text-center ">Check out fish prices here!</p>
          ...
          <Toast.Body>Added { getObjectValues()}</Toast.Body>
        </Toast>
        <br />
        <br />
      </section>
