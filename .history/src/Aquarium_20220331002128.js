...
const Aquarium = () => {
  ...
  const addFish = (value) => {
    ...
    window.sessionStorage.setItem("fishNames", JSON.stringify(fishList));
  ...
  // let y = new Fish("value.fishID", "value.fishCommonName", "value.fishScientificName", "value.fishAverageSize", "value.fishLowerPH", "value.fishUpperPH", "value.fishLowerTemp", "value.fishUpperTemp", "value.fishAggrSameSpecies", "value.fishAggrOtherSpecies", "value.fishLocationTank", "value.fishImage");
  let x = "";
  return (
    <div>
      <section className="home">
        ...
        <p className="text-center ">Check out fish prices here!</p>
          ...
          {x = JSON.parse(sessionStorage.fishNames)}
          <Toast.Body>Added {x.commonName}</Toast.Body>
        </Toast>
        <br />
        <br />
      </section>
