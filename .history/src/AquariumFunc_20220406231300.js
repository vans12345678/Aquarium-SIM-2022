  ...
  userList.forEach((element) => {
    ...
    //Otherwise they are different fish
      ...
      if (
        ...
        console.log(
          "The different fish are aggressive/territorial to each other"
        );
        flag = false;
      }
      ...
      //new fish is aggressive to smaller
        ...
        newFish.aggressiveOtherSpecies == "aggressive to smaller" &&
        element.aggressiveOtherSpecies == "peaceful"
      ) {
        ...
        if (newFish.averageSize * 0.85 > element.averageSize) {
          console.log(
            "new fish is smaller than tank fish whom is aggressive to smaller"
          );
          flag = false;
        }
      } else if (
        ...
        if (element.averageSize * 0.85 > newFish.averageSize) {
          console.log(
            "old fish (aggressive to smaller) bigger than new fish (aggressive to smaller)"
          );
          flag = false;
        }
        //Checks to see if the new fish is bigger than the old fish
          ...
          console.log(
            "new fish (aggressive to smaller) is bigger than old fish (aggressive to smaller)"
          );
          flag = false;
        } else {
          console.log(
            "new fish (aggressive to smaller) same size as old fish (aggressive to smaller)"
          );
          flag = flag;
        }
      }
