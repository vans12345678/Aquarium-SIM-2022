...
(async () => {
    ...
    for (let i = 0; i < 1; i++)
    {
        let fishSciName = fullFishSpecArrays[i][0];
        ...
        " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);", [fullFishSpecArrays[i][0];, fishCommonName, fishAverageSize, fishLowerPH, fishUpperPH, fishLowerTemp, fishUpperTemp, fishAggrSameSpecies, fishAggrOtherSpecies, fishLocationTank]; 
