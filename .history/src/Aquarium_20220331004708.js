...
const Aquarium = () => {
  ...
  const addFish = (value) => {
    ...
    var test = JSON.parse(sessionStorage.getItem("fishNames", "commoonNAme"));
    toggleShowA();
    //alert("Added" + fish.commonName);
  };
    ...
    <div>
      <section className="home">
        ...
        <p className="text-center ">Check out fish prices here!</p>
          ...
          <Toast.Body>Added { fish.commonName }</Toast.Body>
        </Toast>
        <br />
        <br />
      </section>
