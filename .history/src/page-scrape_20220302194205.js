...
(async () => {
    ...
    for (let i = 0; i < 1; i++)
    {
        var fishSciName = fullFishSpecArrays[i][0];
        var fishCommonName = fullFishSpecArrays[i][1]; 
        var fishAverageSize = fullFishSpecArrays[i][2]; 
        var fishLowerPH = fullFishSpecArrays[i][3]; 
        var fishUpperPH = fullFishSpecArrays[i][4]; 
        var fishLowerTemp = fullFishSpecArrays[i][5];
        var fishUpperTemp = fullFishSpecArrays[i][6]; 
        var fishAggrSameSpecies = fullFishSpecArrays[i][7]; 
        var fishAggrOtherSpecies =fullFishSpecArrays[i][8];
        var fishLocationTank=fullFishSpecArrays[i][9];
