...
export const testTankSize = (length, width, height, tank, userList) =>
{
  ...
  if(length > 0 && width > 0 && height > 0 && ((1-((tempTankSize - (sumAllFish))/tempTankSize))*100) <= 100)
  {
    flag = true;
  }
  else
...
export const testFishAggression = (userList, newFish) =>
{
    ...
    {    
      ...
      //new fish is aggressive to smaller
      else if(newFish.aggressiveOtherSpecies == "aggressive to smaller" && element.aggressiveOtherSpecies == "peaceful")
      {
