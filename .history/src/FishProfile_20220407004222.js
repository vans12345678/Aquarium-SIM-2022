...
const FishProfile = () => {
  ...
  const getCurrentFish = () => {
    if (fishInfo.length === 0) {
      Axios.post("https://mysql-aquarium.herokuapp.com/api/currentFishGet", {
  ...
  return (
    <div>
      ...
      <section className="darkSection">
                ...
                <tbody className="section">
                  <tr className="mb-4">
                    <td>
                      <b>
                        <NavLink
                          className="darkBlueText externalLinks"
                          to={{
                            pathname:
        ...
        <b>
          &nbsp; &nbsp;
          <NavLink className="darkBlueText" to="/Compendium">
            Return to Compendium Page
          </NavLink>
        </b>
        <br />
        <br />
