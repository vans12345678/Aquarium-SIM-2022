...
const Compendium = () => {
  ...
  var pagesVisited = pageNumber * entriesPerPage;
  var displayEntries = fishList.slice(pagesVisited, pagesVisited + entriesPerPage).map((fishList)=>{
    return (
      <tr key={fishList.fishID}>
        <td>{fishList.fishCommonName}</td>
        <td>{fishList.fishScientificName}</td>
        <td>
          <NavLink to={`/fishprofile/${fishList.fishScientificName}`}>Here</NavLink>
        </td>
