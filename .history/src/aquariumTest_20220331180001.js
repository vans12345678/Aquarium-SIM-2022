const aquariumTest = React.Component({
...
const FruitList = React.Component({
  render: function () {
    return (
...
var AddFruitForm = React.Component({
...
var RemoveFruitForm = React.Component({
  ...
  render: function () {
    return (
      <form
        ...
        ref="removeFruitForm"
        onChange={this.selectFruittoRemove}
      >
        <div className="form-group">
...
// React.render(<aquariumTest />, document.getElementById("app"));
export default aquariumTest;
