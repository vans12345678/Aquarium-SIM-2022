...
// Animate the button
function animate() {
  swordtailSprite.position.x = swordtailSprite.position.x + 5;
  if (swordtailSprite.position.x > stage.props.width + swordtailSprite.width) {
    swordtailSprite.position.x = -swordtailSprite.width;
  }
}
    ...
    <div>
      ...
      <section className="homeMiddle">
        ...
        <Stage width={3000} height={1500} options={{ backgroundAlpha: 0 }}>
          {background}
          {console.log(swordtailSprite.props.x)}
