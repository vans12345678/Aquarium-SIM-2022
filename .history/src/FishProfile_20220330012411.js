        ...
        return(
          <div key = {val.fishID}>
            ...
            className="w-50 text-center">
              ...
              <tr>
                <td>
                {formatFishNameForLink(val.fishCommonName, val.fishScientificName)}
                <NavLink to={{pathname:"https://en.aqua-fish.net/fish/"}} target="_blank">Aqua-fish.net</NavLink>
                </td>
              </tr>
            </Table>
      </div>
