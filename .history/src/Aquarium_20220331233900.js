...
var AddFishForm = React.createReactClass({
  ...
  render : function() {
    return(
      <form className="form-inline" ref="fishForm" onSubmit={this.createFruit}>
        <div className="form-group">
          <label for="fishItem">
            Fish Name
            <input type="text" id="fishItem" className="form-control" placeholder="e.x.lemmon" ref="fishName" />
          </label>
        </div>
        <button type="submit" className="btn btn-primary">Add Fish</button>
      </form>
    )
