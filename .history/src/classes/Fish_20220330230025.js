export class Fish 
{
    constructor(id, commonName, scientificName, averageSize, lowerPH, upperPH, lowerTemp, upperTemp, aggressiveSameSpecies, aggressiveOtherSpecies, locationTank, image) 
    {
      this.id = id;
    ...
    toString()
    {
        return "Common name: " + this.commonName + "\n" +
                ...
                "Lower Temp: " + this.lowerTemp + "\n" +
                "Upper Temp: " + this.upperTemp + "\n" +
