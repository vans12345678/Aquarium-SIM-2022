...
(async () => {
    ...
    const sqlInsert = "INSERT INTO tblfish" + 
    "(fishID, fishScientificName, fishCommonName, fishAverageSize, fishLowerPH, fishUpperPH, fishLowerTemp, fishAggrSameSpecies, fishAggrOtherSpecies, fishLocationTank)" +
