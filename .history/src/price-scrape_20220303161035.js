...
(async () => {
    ...
    const inner_html = await page.evaluate(() => document.getElementsByClassName("product grid__item medium-up--one-third small--one-half slide-up-animation animated"));
