        ...
        if (testTemperature(fishTank, fish) == true) {
          if (testPH(fishTank, fish) == true) {
            if (testFishSize(userList, fish, fishTank) == true) {
              ...
              else if (((fish.averageSize/maxDimension)40) < 50 && ((fish.averageSize/maxDimension)40) > 20){
                  //Big fish animation
              }
              else if (((fish.averageSize/maxDimension)40) < 20 && ((fish.averageSize/maxDimension)*40) > 10){
