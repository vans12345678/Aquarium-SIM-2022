...
const Aquarium = () => {
  ...
  let x = new Fish("value.fishID", "value.fishCommonName", "value.fishScientificName", "value.fishAverageSize", "value.fishLowerPH", "value.fishUpperPH", "value.fishLowerTemp", "value.fishUpperTemp", "value.fishAggrSameSpecies", "value.fishAggrOtherSpecies", "value.fishLocationTank", "value.fishImage");
  return (
    <div>
