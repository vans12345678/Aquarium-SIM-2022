...
(async () => {
    ...
    for(let i = 0; i < nameArrSet.length; i ++)
    {
        ...
        if(nameArrSet[i] != "")
        {
            ...
            if(nameArrSet[i] != null)
            {
                //nameArrSet[i] = regExp.exec(nameArrSet[i]);
                sciNameArr.push(nameArrSet[i]);
            }
            if(nameArrSet[i] == null)
            {
                console.log(nameArrSet[i]);
            }
