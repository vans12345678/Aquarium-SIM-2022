...
(async () => {
    ...
    await page.goto('https://aquaristsacrosscanada.com/collections/rainbowfish');
    ...
    {       
        ...
        if(sciNameArr[i] != null && priceArr[i] != "")
        {
            ...
            let sqlInsert = "INSERT INTO tblrainbow(rainbowCommonName, rainbowScientificName, rainbowPrice) VALUES (?);"; 
