...
(async () => {
    ...
    for(let i = 0; i <= 742; i++)
    {
        ...
        await page.evaluate((i) => { 
            ...
            console.log(document.getElementById("LN" + i + "_" + i).innerHTML); 
        
        }, 'FOO');

        const moreContent = await page.evaluate(() => document.getElementById("LN" + 0 + "_" + 0).innerHTML);
        const text = document.getElementById("LN" + 0 + "_" + 0).innerHTML;
        x=moreContent;
